...
# df <- read.delim("/Users/sar210/Box/MDx_project/generated_distance_combined.txt")

netwk <- read.delim("/Users/sar210/Box/MDx_project/Homosapiens_comb_hq.txt", header = F)
...
h_gene_sets = msigdbr(species = "Homo sapiens", category = "C2", subcategory = "CP:BIOCARTA")
...
# write.csv(M, "results_pattern1122_C2_BIOCARTA.csv")
# write.csv(M, "results_pattern1112_C2_BIOCARTA.csv")
# write.csv(M, "results_pattern1234_C2_BIOCARTA.csv")
# write.csv(M, "results_pattern_1122_1234_C2_BIOCARTA.csv")
write.csv(M, "results_patternCombined_C2_BIOCARTA.csv")
# write.csv(GS_NAME, "C2_BIOCARTA_Pathway.csv")
...
#   sub_gene_set <- subset.data.frame(h_gene_sets, gs_name == gs)
#   TNF <- sub_gene_set$human_gene_symbol
#   numberOfGenes[i] <- length(TNF)
# }
# write.csv(GS_NAME, "C2_Biocarta_Pathway.csv")
# write.csv(numberOfGenes, "numberOfGenes_C2_Biocarta_Pathway.csv")
